...
class ConnectivityMapSpec extends UnitSpec {
  ...
  "Passing a gene expression profile and query signature to connectionScore" should
    "return a connection strength tuple with score 1.0 when maxConnectionStrength has the same strength value" in {
