...
trait ReferenceSetCreatorComponent {
  def referenceSetCreator: ReferenceSetCreator
...
trait ReferenceSetCreatorByDrugDoseAndCellLineComponent extends ReferenceSetCreatorComponent {
  val referenceSetCreator = new ReferenceSetCreatorByDrugDoseAndCellLine
   ...
   */
  class ReferenceSetCreatorByDrugDoseAndCellLine extends ReferenceSetCreator {
